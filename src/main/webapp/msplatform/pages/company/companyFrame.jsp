...
<body style="padding:2px" onload="setpage();">
	<div id="layout1">
		<!-- 左侧树型 -->
		<div position="left" title="组织机构">
			<table height="100%">
				<tr>
					<td><iframe
							src="${ctx}/msplatform/pages/company/companyTree.jsp?type=company&comType=1"
		...
		<!--公司管理 -->
		<div position="center" title="公司管理">
			<iframe src="${ctx}/company/company_queryByTree" frameborder="0"
