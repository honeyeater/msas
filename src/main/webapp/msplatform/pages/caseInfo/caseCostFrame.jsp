     ...
     <body style="padding:2px">  
      <div id="layout1">
          ...
          <table width="185" height="100%" border="0" cellspacing="0" cellpadding="0" style="">
              <tr>
                <td><iframe  src="${ctx}/msplatform/pages/company/companyTree.jsp?type=caseCost&comType=1&locationId=0002"
                 frameborder="0" class="iframe1" name="Menu" id="Menu"></iframe></td>
              </tr>
            </table>
            </div>
            <!-- 区域管理 -->
            <div position="center" title="结算案件管理" >
            <iframe  src="${ctx}/caseInfo/caseInfo_queryCostByTree"  
