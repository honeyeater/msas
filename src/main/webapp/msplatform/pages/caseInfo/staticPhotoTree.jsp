...
<script src="${ctx}/msplatform/js/common/jquery.ztree.core-3.5.js"
	type="text/javascript"></script>
<script src="${ctx}/msplatform/js/caseInfo/photoTree.js"
	type="text/javascript"></script>
</head>

<body onunload="close()" style="background: #fff">
	<input type="hidden" id="treeType" value="${treeType}" />
	<div id="left_list"  style="height:28px; margin-top:5px;">
		<div><select id="selectTest" name="selectTest" style="width:80px; height:28px; line-height:28px; border:1px solid #ccc; float:left; margin-right:4px;">
			<option value="1" selected="selected">查勘员</option>
			<option value="2">手机自助</option>
			</select> 
			<input type="text" id="key" value="" class="empty"
				style="line-height:24px; width:63px; height:24px; border:1px solid #ccc; float:left;" /><a				
				onclick=searchTree(); alt="搜索" class="a_ss"/></a>				
		</div>
