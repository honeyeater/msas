	            ...
	            plotShadow: false, 
 				events: {
					...
					if(seriesList.length > 0)
						{
							this.setTitle({text: "<a href='#' style=' cursor:hand;color:#0079FF ;text-decoration:underline' onclick='query()' >理算员状态详情</a>",useHTML:true }); 
						}
					}
				} 
            }, 
...
function query(){
	window.open("${ctx}/board/board_countCaseList?linetype=2");
}
function myrefresh(){			
