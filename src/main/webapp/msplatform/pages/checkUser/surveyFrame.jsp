	...
	<div id="layout1">
		...
		<div position="left" title="组织机构">
			<table height="100%">
				<tr>
					<td><iframe
							src="${ctx}/msplatform/pages/company/companyTree.jsp?type=survey"
		...
		<!--查勘员管理 -->
		<div position="center" title="查勘员管理">
			<iframe src="${ctx}/checkUser/checkUser_queryByTree?checkType=1" frameborder="0"
