	...
	<div id="layout1">
		...
		<div position="left" title="组织机构">	
			<table height="100%">
				<tr>
					<td><iframe
							src="${ctx}/msplatform/pages/company/companyTree.jsp?type=location"
		...
		<!--区域管理 -->
		<div position="center" title="区域管理">
			<iframe src="${ctx}/location/location_queryByTree" frameborder="0"
